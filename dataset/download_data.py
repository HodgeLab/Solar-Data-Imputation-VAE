...
API_KEY = "bacW1RhJ7KUTenKpBApQk0Rtx9VnYrmfLyccZU5U"
EMAIL = "muhy.zater@colorado.edu"
...
def main():
    input_data = {
        'attributes': 'air_temperature,dhi,dni,ghi,wind_speed,wind_direction',
        'interval': '30',
        
        'api_key': API_KEY,
        'email': EMAIL,
    }
    for name in ['2006','2005','2004','2003','2002','2001']:
